...
export default {
    ...
    async created() {
        ...
        const resp = await axios.get("http://192.168.178.103:8080/api/v1/user/profile/colleagues", options);
        if (resp.status != 200) {
    ...
    methods: {
        ...
        async invite(user) {
            ...
            const resp = await axios.post("http://192.168.178.103:8080/api/v1/app/member/invite", payload, options);
            if (resp.status === 200) {
