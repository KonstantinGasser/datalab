...
export default {
    ...
    methods: {
        ...
        updateStages() {
            ...
            axios.post("http://192.168.178.103:8080/api/v1/app/config/upsert?flag=funnel", payload, options).then(res => {
                console.log(res);
        ...
        updateCampaigns() {
            ...
            axios.post("http://192.168.178.103:8080/api/v1/app/config/upsert?flag=campaign", payload, options).then(res => {
                console.log(res);
        ...
        updateBtnTime() {
            ...
            axios.post("http://192.168.178.103:8080/api/v1/app/config/upsert?flag=btn_time", payload, options).then(res => {
                console.log(res);
