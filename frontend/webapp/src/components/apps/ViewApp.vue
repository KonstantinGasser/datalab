    ...
    export default {
        ...
        methods: {
            ...
            async getAppList() {
                ...
                const resp = await axios.get("http://192.168.178.103:8080/api/v1/app/getall", options)
                if (resp.status != 200) {
            ...
            async getApp(uuid) {
                ...
                let resp = {}
                try {
                    resp = await axios.get("http://192.168.178.103:8080/api/v1/app/get?app="+uuid, options)
                    if (resp.status != 200) {
                        this.$toast.error(resp.data);
                    }
                    return resp.data
            ...
            async getViewApp() {
                ...
                const res = await axios.get("http://192.168.178.103:8080/api/v2/view/app/details", options)
            ...
            async getAppDetails(uuid) {
                ...
                axios.get("http://192.168.178.103:8080/api/v2/view/app/get?uuid="+uuid, options).then(resp => {
