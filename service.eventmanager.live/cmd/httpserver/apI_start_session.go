...
func (server *Server) StartSession(w http.ResponseWriter, r *http.Request) {
	logrus.Infof("[server.StartSession] received request\n")
	...
	config, err := server.metaFetchingService.FetchConfigMetaData(r.Context(), request.AppUuid)
	if err != nil {
