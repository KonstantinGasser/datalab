...
type Service interface {
	FetchById(ctx context.Context, appUuid string, userUuid string, readWriteUuids ...string) (*apptokens.AppToken, errors.Api)
}
...
func (s *service) FetchById(ctx context.Context, appUuid string, userUuid string, readWriteUuids ...string) (*apptokens.AppToken, errors.Api) {
	...
	if err := storedAppToken.HasReadOrWrite(userUuid, readWriteUuids...); err != nil {
